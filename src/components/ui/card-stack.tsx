...
export function CardStack<T extends CardStackItem>({
  ...
  const actualWidth = isMobile ? Math.min(typeof window !== "undefined" ? window.innerWidth - 64 : 320, 340) : cardWidth;
  const actualHeight = isMobile ? 420 : cardHeight;
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: Math.max(380, actualHeight + 80) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
              ...
              const dragProps = isActive
                ? {
                    ...
                    onDragEnd: (
                      ...
                      const threshold = Math.min(160, actualWidth * 0.22);
  ...
  return (
    <div className="relative h-full w-full bg-white">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.href ? (
          <a href={item.href} target="_blank" rel="noopener noreferrer" className="hover:underline flex items-center gap-2 group w-max">
            <div className="truncate text-lg font-semibold text-white">
              {item.title}
            </div>
            <SquareArrowOutUpRight className="h-4 w-4 text-white/70 group-hover:text-white transition-colors" />
          </a>
        ) : (
          <div className="truncate text-lg font-semibold text-white">
            {item.title}
