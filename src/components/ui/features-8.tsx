...
import { Rocket, CodeSquare, Shield, Users } from 'lucide-react'
        ...
        <section className="w-full">
            <div className="mx-auto w-full max-w-full">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-6 gap-3 sm:gap-4">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] hover:bg-white/30 transition-colors">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    <svg className="text-gray-900/10 absolute inset-0 size-full" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-bold text-gray-900">100%</span>
                                </div>
                                <h2 className="mt-6 text-center text-2xl font-bold text-gray-900">Execution Rate</h2>
                            </CardContent>
                        </Card>
                        
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] hover:bg-white/30 transition-colors">
                            <CardContent className="pt-8">
                                <div className="relative mx-auto flex aspect-square size-24 rounded-full border border-white/40 bg-white/40 text-gray-900 items-center justify-center">
                                    <CodeSquare className="size-10" strokeWidth={1.5} />
                                </div>
                                <div className="relative z-10 mt-8 space-y-2 text-center">
                                    <h2 className="text-xl font-bold text-gray-900 transition">Web & Business Dev</h2>
                                    <p className="text-gray-800 leading-relaxed text-sm">
                                        This platform serves to entertain and challenge me, bagaspra16, in professional web development and business strategy execution.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] hover:bg-white/30 transition-colors">
                            <CardContent className="pt-8">
                                ...
                                <div className="relative z-10 mt-8 space-y-2 text-center">
                                    <h2 className="text-xl font-bold text-gray-900 transition">Idea Executor</h2>
                                    <p className="text-gray-800 leading-relaxed text-sm">
                                        An exclusive playground designed to showcase exactly what I can build and deliver in the shortest amount of time possible.
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        {/* Card 4 (Bottom Left) */}
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] hover:bg-white/30 transition-colors">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border border-white/40 bg-white/40 text-gray-900">
                                        <Shield className="m-auto size-5" strokeWidth={1.5} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-bold text-gray-900 transition">Secure Infrastructure</h2>
                                        <p className="text-sm text-gray-800">
                                            Ensuring every architecture built rests on a solid, secure foundation that effortlessly scales alongside growing business ideas.
                                        </p>
                                    </div>
                                </div>
                                <div className="rounded-tl-[var(--radius)] relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/30 bg-white/10 p-6 py-6 sm:ml-6">
                                    <div className="absolute left-3 top-2 flex gap-1">
                                        <span className="block size-2 rounded-full border border-gray-400 bg-gray-300"></span>
                                        <span className="block size-2 rounded-full border border-gray-400 bg-gray-300"></span>
                                        <span className="block size-2 rounded-full border border-gray-400 bg-gray-300"></span>
                                    </div>
                                    <svg className="w-full sm:w-[150%] text-gray-400/30" viewBox="0 0 366 231" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            fillRule="evenodd"
                                            clipRule="evenodd"
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3 bg-white/20 backdrop-blur-xl border border-white/30 shadow-[0_8px_32px_0_rgba(31,38,135,0.15)] hover:bg-white/30 transition-colors">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-bold text-gray-900 transition">Engineering Power</h2>
                                        <p className="text-sm text-gray-800">Architecting and building ideas from the ground up independently. Phenomenal execution relies on deep focus and an unyielding engineering spirit.</p>
                                    </div>
                                </div>
                                <div className="relative mt-6 sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col items-center justify-center space-y-4 py-6">
                                        <div className="ring-white/50 size-20 ring-4 rounded-full overflow-hidden shadow-lg border border-white/40">
                                            <img className="size-full object-cover" src="/bagas.jpg" alt="Bagas Pratama Junianika" />
                                        </div>
                                        <span className="block h-fit rounded-full border border-white/40 bg-white/50 px-4 py-1.5 text-sm font-semibold text-gray-900 shadow-sm backdrop-blur-md tracking-tight">Full-Stack Engineer</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
